...
namespace _1263087.Controllers
{
    public class StaffsController : Controller
    {
        ...
        public StaffsController(ApplicationDbContext context, IWebHostEnvironment webHost)
        {
        ...
        private string GetUploadedFileName(Staff staff)
        {
        ...
        public async Task<IActionResult> Create( StaffVM staffVM)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                string uniqueFileName = GetUploadedFileName(staff);
